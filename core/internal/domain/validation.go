...
const (
	...
	CodeInvalidTLSChallenge          ErrorCode = "INVALID_TLS_CHALLENGE"
	CodeInvalidDNSProvider           ErrorCode = "INVALID_DNS_PROVIDER"
	CodeInvalidDNSZone               ErrorCode = "INVALID_DNS_ZONE"
	CodeInvalidDNSProviderCredential ErrorCode = "INVALID_DNS_PROVIDER_CREDENTIAL"
)
