...
func TestMigrationIntegrityRejectsModifiedAppliedMigration(t *testing.T) {
	...
	defer database.Close()
	altered := migrationSubset(t, "0001_bootstrap.sql", "0002_migration_integrity.sql", "0003_core_schema.sql", "0004_runtime_state.sql", "0005_tls_runtime_dirty.sql", "0006_revision_sequence.sql", "0007_revision_state_snapshot.sql", "0008_dns_provider_credentials.sql", "0009_dnspod_token_provider.sql", "0010_revision_state_hash.sql")
